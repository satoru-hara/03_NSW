...
[![License: Dual License](https://img.shields.io/badge/License-Dual%20License-lightgrey.svg)](../../../LICENSE_v2.0.md)
...
pip install -e 03_NSW/01-Docs/05-Implementations/hns36_pkg
```
...
HNS-36 is provided under the repository's **Dual License Agreement**.

- **Non-commercial use** is permitted for research, study, review, education, and non-commercial evaluation, subject to the license terms.
- **Commercial, institutional, enterprise, certification, audit, regulatory, or revenue-related use** requires a separate written commercial license.

See [LICENSE_v2.0.md](../../../LICENSE_v2.0.md) for the full terms.

© 2026 Satoru Hara / Natural Structure Works (NSW). All rights reserved.
