...
- `FullStack_Architecture_Diagram.png`  
  → Diagram of the five‑layer OS architecture
- `Series_Index.md`  
  → Index linking to all specifications in the series

---

## 6. Versioning

The series uses the following versioning format:
...
This date marks the point at which the EVA × HNS × HumanOS architecture became **fully integrated, internally consistent, and structurally complete**.
...
All rights reserved.  
No part of this series may be reproduced or redistributed without prior written permission,  
except for brief quotations in academic or technical contexts.
