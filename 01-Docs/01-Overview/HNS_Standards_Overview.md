...
|---|---|---|---|---|
| **The HNS Origin Trilogy: Brain Architecture as the Foundation of Trustworthy AI** | Hara, S. | May 26, 2026 (v1) | Preprint | Foundational trilogy presenting MAV framework, HNS-36/144/864 matrices, SMS-6 grounding protocol, and structural isomorphism between biological cognition and HNS-aligned AI |
| **Human Natural Structure: Implementing the Brain's Multi-Axis Verification Process for Advanced AI Alignment** | Hara, S. | May 26, 2026 (v1) | Preprint | Operationalisation of MAV within AI pipelines; empirical evaluation across 50-turn sequences; 100% auditability and <1% latency overhead |
| **The Multi-Axis Verification Process of the Human Brain: A Brain-Inspired Architecture for Geometric Error-Correction in Stochastic Cognitive Systems** | Hara, S. | May 26, 2026 (v1) | Preprint | Formal specification of MAV; information-geometry proof of orthogonality; taxonomy of cognitive failure modes |
| **EVA-HNS: A Structural Full-Stack Operating System for AI Alignment — Architecture and 50-Turn Evidence** | Hara, S. | May 24, 2026 (v1) | Working Paper | Compact research overview of EVA-HNS architecture; 50-turn PoC experiment; HNS Structural Stability Benchmark roadmap |
| **Structural OS for Human Understanding (SOHU): A Full-Stack Architecture for Meaning, Cognition, and AI Alignment** | Hara, S. | May 22, 2026 (v1) | Preprint | SOHU five-layer stack (Semantic / Cognitive / Interaction / Context / Civilisation OS); integration with EVA; ISO/IEC 42001, EU AI Act, IEEE P7001 alignment |
| **External Verification Architecture (EVA)** | Hara, S. | May 8, 2026 (v1.0) | Publication | Hardware-anchored safety framework; model-agnostic external verification layer; EU AI Act, ISO/IEC 42001, CEN-CENELEC JTC 21 compatibility |
| **Human Natural Structure (HNS): A Structural Operating System for Human Understanding in AI — Full Manuscript** | Hara, S. | April 17, 2026 (v1.0) | Publication | Full manuscript; HNS-36 six-layer × six-category matrix; applications in conversational AI, alignment, safety, education, healthcare |
| **Human Natural Structure (HNS): A Structural Operating System for Human Understanding in AI** | Hara, S. | March 19, 2026 (v1) | Report | Original HNS report; HNS-36/144/864 framework; structural gap analysis; 20+ volumes across KFW, NAW, NSW domains |
