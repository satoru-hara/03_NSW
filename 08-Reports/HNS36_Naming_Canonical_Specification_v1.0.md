...
- HNS v1.1 (Grok)
- HNS v2.0 (Life/Sensory model)
- HNS v0.1 (OS-style names: PhysicalOS, LoadOS…)
- Foundational Specification (Human Natural Structure 1.0)
...
## 5. Rationale for Canonical Selection
